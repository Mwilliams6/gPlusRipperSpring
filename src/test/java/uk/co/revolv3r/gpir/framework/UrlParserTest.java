...
//
//  private UrlParser mUrlParser = new UrlParser();
//
//  private final String xml, expected, message;
//
//  private final int first, shift;
//
//  public UrlParserTest(final String aXml,
...
//  {
//    final String result = mUrlParser.renumber(xml,first,shift,PFX,SFX,PADDING);
